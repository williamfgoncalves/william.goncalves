...
import br.com.crescer.aula1.StringUtils;
import br.com.crescer.aula1.TestStringUtils;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new TestStringUtils();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@OdynJr"};
        }
